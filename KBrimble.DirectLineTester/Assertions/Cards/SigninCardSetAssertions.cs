...
namespace KBrimble.DirectLineTester.Assertions.Cards
{
    ...
    {
        private readonly IEnumerable<SigninCard> _signinCards;
        ...
        public ISigninCardAssertions HasTextMatching(string regex)
        {
            ...
            _setHelpers.TestSetForMatch(_signinCards, card => card.That().HasTextMatching(regex), CreateEx(nameof(SigninCard.Text), regex));
        ...
        public ISigninCardAssertions HasTextMatching(string regex, string groupMatchRegex, out IList<string> matchedGroups)
        {
            ...
            matchedGroups = _setHelpers.TestSetForMatchAndReturnGroups(_signinCards, act, CreateEx(nameof(SigninCard.Text), regex));
        ...
        {
            return new CardActionSetAssertions(_signinCards);
        }
