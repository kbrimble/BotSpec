...
namespace Expecto.Tests.Unit.CardAssertionTests.CardComponentAssertionTests.When_testing_card_action_sets
{
    ...
    public class For_a_title_matching
    {
        ...
        public void TitleMatching_should_pass_if_regex_exactly_matches_Title_of_at_least_1_card_regardless_of_case(string title, string regex)
        {
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void TitleMatching_should_throw_CardActionAssertionFailedException_when_regex_matches_no_cards(string regex)
        {
        ...
        [Test]
        public void TitleMatching_should_throw_CardActionAssertionFailedException_when_Title_of_all_cards_is_null()
        {
        ...
        [Test]
        public void TitleMatching_should_throw_CardActionAssertionFailedException_when_trying_to_capture_groups_but_Title_of_all_cards_is_null()
        {
        ...
        [Test]
        public void TitleMatching_should_throw_ArgumentNullException_when_capturing_groups_if_regex_is_null()
        {
            IList<string> matches;
