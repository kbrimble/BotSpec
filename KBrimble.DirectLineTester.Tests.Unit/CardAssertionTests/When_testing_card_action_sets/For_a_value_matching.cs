...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.When_testing_card_action_sets
{
    ...
    public class For_a_value_matching
    {
        ...
        {
            var cardActions = CardActionTestData.CreateCardActionSetWithOneMessageThatHasSetProperties(value: cardValueAndRegex);
        ...
        {
            var cardActions = CardActionTestData.CreateCardActionSetWithOneMessageThatHasSetProperties(value: value);
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HasValueMatching_should_throw_CardActionSetAssertionFailedException_when_regex_matches_no_cards(string regex)
        {
        ...
        [Test]
        public void HasValueMatching_should_throw_CardActionSetAssertionFailedException_when_Value_of_all_cards_is_null()
        {
        ...
        [Test]
        public void HasValueMatching_should_throw_CardActionSetAssertionFailedException_when_trying_to_capture_groups_but_Value_of_all_cards_is_null()
        {
        ...
        public void HasValueMatching_should_output_matches_when_groupMatchingRegex_matches_Value_of_any_card()
        {
            ...
            var cardActions = CardActionTestData.CreateCardActionSetWithOneMessageThatHasSetProperties(value: someValue);
