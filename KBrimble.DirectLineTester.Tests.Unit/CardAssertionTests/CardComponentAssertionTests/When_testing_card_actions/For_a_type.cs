...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.CardComponentAssertionTests.When_testing_card_actions
{
    ...
    public class For_a_type
    {
        ...
        [Test]
        public void HasType_should_throw_CardActionAssertionFailedException_when_card_action_type_has_an_invalid_value()
        {
        ...
        [Test]
        public void HasTypeMatching_should_throw_CardActionAssertionFailedException_for_non_matching_types()
        {
            var cardAction = new CardAction(type: CardActionType.Call.Value);
        ...
        [Test]
        public void HasTypeMatching_should_throw_CardActionAssertionFailedException_when_type_of_card_action_is_null()
        {
