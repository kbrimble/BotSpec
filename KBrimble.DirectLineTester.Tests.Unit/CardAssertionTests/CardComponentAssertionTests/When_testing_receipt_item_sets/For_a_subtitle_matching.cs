...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.CardComponentAssertionTests.When_testing_receipt_item_sets
{
    ...
    public class For_a_subtitle_matching
    {
        ...
        [TestCase("")]
        [TestCase("symbols ([*])?")]
        public void HasSubtitleMatching_should_pass_if_regex_exactly_matches_message_Subtitle_of_one_item(string itemSubtitleAndRegex)
        {
        ...
        public void HasSubtitleMatching_should_pass_if_regex_exactly_matches_Subtitle_of_at_least_1_item_regardless_of_case(string itemSubtitle, string regex)
        {
        ...
        public void HasSubtitleMatching_should_pass_when_using_standard_regex_features(string itemSubtitle, string regex)
        {
            var items = ReceiptItemTestData.CreateReceiptItemSetWithOneItemThatHasSetProperties(subtitle: itemSubtitle);
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HasSubtitleMatching_should_throw_ReceiptItemAssertionFailedException_when_regex_matches_no_items(string regex)
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_ReceiptItemAssertionFailedException_when_Subtitle_of_all_items_is_null()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_ReceiptItemAssertionFailedException_when_trying_to_capture_groups_but_Subtitle_of_all_items_is_null()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_not_output_matches_when_regex_does_not_match_Subtitle_of_any_items()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_not_output_matches_when_groupMatchingRegex_does_not_match_Subtitle_of_any_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasSubtitleMatching_should_output_matches_when_groupMatchingRegex_matches_Subtitle_of_any_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasSubtitleMatching_should_output_multiple_matches_when_groupMatchingRegex_matches_Subtitle_several_times_for_a_single_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasSubtitleMatching_should_output_multiple_matches_when_groupMatchingRegex_matches_Subtitle_on_multiple_items()
        {
            IList<string> matches;
