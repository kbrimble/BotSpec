...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.CardComponentAssertionTests.When_testing_receipt_item_sets
{
    ...
    public class For_text_matching
    {
        ...
        [TestCase("")]
        [TestCase("symbols ([*])?")]
        public void HasTextMatching_should_pass_if_regex_exactly_matches_message_Text_of_one_item(string itemTextAndRegex)
        {
            ...
            Action act = () => sut.HasTextMatching(itemTextAndRegex);
        ...
        public void HasTextMatching_should_pass_if_regex_exactly_matches_Text_of_at_least_1_item_regardless_of_case(string itemText, string regex)
        {
        ...
        public void HasTextMatching_should_pass_when_using_standard_regex_features(string itemText, string regex)
        {
            var items = ReceiptItemTestData.CreateReceiptItemSetWithOneItemThatHasSetProperties(text: itemText);
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HasTextMatching_should_throw_ReceiptItemAssertionFailedException_when_regex_matches_no_items(string regex)
        {
        ...
        [Test]
        public void HasTextMatching_should_throw_ReceiptItemAssertionFailedException_when_Text_of_all_items_is_null()
        {
        ...
        [Test]
        public void HasTextMatching_should_throw_ReceiptItemAssertionFailedException_when_trying_to_capture_groups_but_Text_of_all_items_is_null()
        {
        ...
        [Test]
        public void HasTextMatching_should_not_output_matches_when_regex_does_not_match_Text_of_any_items()
        {
        ...
        [Test]
        public void HasTextMatching_should_not_output_matches_when_groupMatchingRegex_does_not_match_Text_of_any_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasTextMatching_should_output_matches_when_groupMatchingRegex_matches_Text_of_any_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasTextMatching_should_output_multiple_matches_when_groupMatchingRegex_matches_Text_several_times_for_a_single_item()
        {
            IList<string> matches;
        ...
        [Test]
        public void HasTextMatching_should_output_multiple_matches_when_groupMatchingRegex_matches_Text_on_multiple_items()
        {
            IList<string> matches;
