...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.When_testing_thumbnail_card_sets
{
    ...
    public class For_text_matching
    {
        ...
        {
            var cards = ThumbnailCardTestData.CreateThumbnailCardSetWithOneCardThatHasSetProperties(text: cardTextAndRegex);
        ...
        {
            var cards = ThumbnailCardTestData.CreateThumbnailCardSetWithOneCardThatHasSetProperties(text: cardText);
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HasTextMatching_should_throw_ThumbnailCardAssertionFailedException_when_regex_matches_no_cards(string regex)
        {
        ...
        [Test]
        public void HasTextMatching_should_throw_ThumbnailCardAssertionFailedException_when_Text_of_all_cards_is_null()
        {
        ...
        [Test]
        public void HasTextMatching_should_throw_ThumbnailCardAssertionFailedException_when_trying_to_capture_groups_but_Text_of_all_cards_is_null()
        {
        ...
        public void HasTextMatching_should_output_matches_when_groupMatchingRegex_matches_Text_of_any_card()
        {
            ...
            var cards = ThumbnailCardTestData.CreateThumbnailCardSetWithOneCardThatHasSetProperties(text: someText);
