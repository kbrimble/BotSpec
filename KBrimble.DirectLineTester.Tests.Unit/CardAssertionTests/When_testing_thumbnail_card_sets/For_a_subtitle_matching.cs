...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.When_testing_thumbnail_card_sets
{
    ...
    public class For_a_subtitle_matching
    {
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HasSubtitleMatching_should_throw_ThumbnailCardAssertionFailedException_when_regex_matches_no_cards(string regex)
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_ThumbnailCardAssertionFailedException_when_Subtitle_of_all_cards_is_null()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_ThumbnailCardAssertionFailedException_when_trying_to_capture_groups_but_Subtitle_of_all_cards_is_null()
        {
