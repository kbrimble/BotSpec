...
namespace KBrimble.DirectLineTester.Tests.Unit.CardAssertionTests.When_testing_groups_of_thumbnail_card_sets
{
    ...
    public class For_a_subtitle_matching
    {
        ...
        public void HasSubtitleMatching_should_throw_GroupOfThumbnailCardSetAssertionFailedException_when_regex_matches_no_cards_in_any_set(string cardSubtitle, string regex)
        {
            var cards = ThumbnailCardSetTestData.CreateGroupOfThumbnailCardSetWithOneCardThatHasSetProperties(subtitle: cardSubtitle).ToList();
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_GroupOfThumbnailCardSetAssertionFailedException_when_Subtitle_of_all_cards_is_null_in_every_set()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_throw_GroupOfThumbnailCardSetAssertionFailedException_when_trying_to_capture_groups_but_Subtitle_of_all_cards_is_null()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_not_output_matches_when_regex_does_not_match_Subtitle_of_any_cards_in_any_set()
        {
        ...
        [Test]
        public void HasSubtitleMatching_should_not_output_matches_when_groupMatchingRegex_does_not_match_Subtitle_of_any_card_in_any_set()
        {
            IList<string> matches = null;
        ...
        [Test]
        public void HasSubtitleMatching_should_output_matches_when_groupMatchingRegex_matches_Subtitle_of_any_card_in_any_set()
        {
            IList<string> matches;

            var cards = ThumbnailCardSetTestData.CreateGroupOfThumbnailCardSetWithOneCardThatHasSetProperties(subtitle: "some text").ToList();

            var sut = new GroupOfThumbnailCardSetAssertions(cards);

            sut.HasSubtitleMatching(".*", "(some text)", out matches);
        ...
        public void HasSubtitleMatching_should_output_multiple_matches_when_groupMatchingRegex_matches_Subtitle_on_multiple_cards()
        {
            ...
            var cards = ThumbnailCardSetTestData.CreateRandomGroupOfThumbnailCardSets().ToList();
            var matchingCard1 = new ThumbnailCard(subtitle: "some text");
            var matchingCard2 = new ThumbnailCard(subtitle: "same text");
