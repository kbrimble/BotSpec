...
namespace KBrimble.DirectLineTester.Tests.Unit.MessageAssertionTests.When_testing_message_sets
{
    ...
    public class For_id_matching
    {
        ...
        [TestCase("^[j-z ]*$")]
        [TestCase("s{12}")]
        public void HaveIdMatching_should_throw_MessageSetAssertionFailedException_when_regex_matches_no_messages(string regex)
        {
        ...
        [Test]
        public void HaveIdMatching_should_throw_MessageSetAssertionFailedException_when_Id_of_all_messages_is_null()
        {
        ...
        [Test]
        public void HaveIdMatching_should_throw_MessageSetAssertionFailedException_when_trying_to_capture_groups_but_Id_of_all_messages_is_null()
        {
